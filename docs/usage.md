...
tumour,AEG588A1_S1_L002_R1_001.fastq.gz,AEG588A1_S1_L002_R2_001.fastq.gz,unstranded
normal,AEG588A1_S2_L002_R1_001.fastq.gz,AEG588A1_S2_L002_R2_001.fastq.gz,unstranded
```
...
A final samplesheet file consisting of both single- and paired-end data may look something like the one below. This is for a paired tumour-normal sample.

```bash
sample,fastq_1,fastq_2,strandedness
tumour,AEG588A1_S1_L002_R1_001.fastq.gz,AEG588A1_S1_L002_R2_001.fastq.gz,unstranded
normal,AEG588A1_S2_L002_R1_001.fastq.gz,,unstranded
```
...
* `docker`
  ...
  * Pulls software from Docker Hub: [`nfcore/conva`](https://hub.docker.com/r/nfcore/conva/)
* `singularity`
